 ...
 * VideoEnabledWebChromeClient. It makes it possible to detect the HTML5 video
 ...
 * 
 */
//com.example.test.VideoEnabledWebView
	...
	private void addJavascriptInterface() {
		if (!addedJavascriptInterface) {
			...
			addJavascriptInterface(new Object() {
				...
				public void notifyVideoEnd() // Must match Javascript interface
												// method of
												// VideoEnabledWebChromeClient
				{
					// This code is not executed in the UI thread, so we must
					// force it to happen
