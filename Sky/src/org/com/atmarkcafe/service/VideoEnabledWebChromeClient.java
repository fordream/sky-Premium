 ...
 * play video. It works with old VideoView-s as well as the new
 * HTML5VideoFullScreen inner classes. With VideoView (typically API level <11),
 * it will always show full-screen. With HTML5VideoFullScreen (typically API
 * level 11+), it will show both in-page and full-screen.
 * 
 ...
 * onBackPressed(). - Tested in Android API level 8+. Only tested on
 * http://m.youtube.com.
 * 
