...
public class ContractUpdateConfirmDialog extends BaseAdialog implements android.view.View.OnClickListener {
	private static final String TAG = "ContractUpdateOptionDialog";
	private String data[];
	private String title_dialog = null;
	public ContractUpdateConfirmDialog(Context context, String data[], OnClickListener clickListener) {
		super(context, clickListener);
		this.data = data;
	}
	
	public ContractUpdateConfirmDialog(Context context, String data[], String title, OnClickListener clickListener) {
		super(context, clickListener);
		this.data = data;
	...
	public int getLayout() {
		return R.layout.v2_contract_popup_confirm_layout;
	}
}