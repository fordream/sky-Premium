...
public class ContractUpdateOptionDialog extends BaseAdialog implements android.view.View.OnClickListener {
	private static final String TAG = "ContractUpdateOptionDialog";
	private String data[];
	private String title_dialog = null;
	public ContractUpdateOptionDialog(Context context, String data[], OnClickListener clickListener) {
		super(context, clickListener);
		this.data = data;
	}
	
	public ContractUpdateOptionDialog(Context context, String data[], String title, OnClickListener clickListener) {
		super(context, clickListener);
		this.data = data;
