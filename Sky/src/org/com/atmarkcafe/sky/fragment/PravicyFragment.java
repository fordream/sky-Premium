...
public class PravicyFragment extends BaseFragment{

	protected static final String TAG = "PravicyFragment";
...
//		btnHome.setImageResource(R.drawable.menu_icon);
	...
	private void updateTitle(){
		if (setting.isLangEng()) {
			txtTile.setTextHeader(R.string.help_policy);
		}else{
			txtTile.setTextHeader(R.string.help_policy_j);
		}
	}
	@Override
	...
	private void getContent(){
		...
		params.put("req[param][slug]", "privacy-policy");
