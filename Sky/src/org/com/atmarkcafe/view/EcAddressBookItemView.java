...
import org.com.atmarkcafe.sky.dialog.EcUpdateAddressBookDialog;
...
public class EcAddressBookItemView extends BaseView implements OnClickListener {
	public EcAddressBookItemView(Context context) {
		super(context);
		/*init(R.layout.ec_addressbook_item_layout);*/
		init(R.layout.v2_ec_addressbook_item2_layout);
		
	}

	public EcAddressBookItemView(Context context, AttributeSet attrs) {
		super(context, attrs);
		/*init(R.layout.ec_addressbook_item_layout);*/
		init(R.layout.v2_ec_addressbook_item2_layout);
	}
	...
	public void onClick(View v) {
		if (mainFragment != null) {
			...
			case R.id.select_address:
				mainFragment.selectAddress((BaseItem) getData());
				break;
			default:
				break;
			}
	...
	EcUpdateAddressBookDialog mainFragment;
	public void addFragment(EcUpdateAddressBookDialog mydialog) {
