...
public class HeaderECView extends LinearLayout {
	private org.com.atmarkcafe.sky.customviews.charting.MTextView text;
	private ImageButton left, right;

	public HeaderECView(Context context) {
		super(context);
		init();
	}

	public HeaderECView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	...
	private void init() {
		((LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.header_ec, this);// header
		try {
