...
public class Products extends SkypeTable {
	@Override
	public int getIndex() {
		return 7;
	}
	...
	public static String address_delivery = "address_delivery";
	public static String address_invoice = "address_invoice";
	public static final String address_type = "address_type";
	public static String ec_credit_confirm_amount = "0";
	public static String address_delivery_type = "address_delivery";
	public static String address_invoice_type = "address_invoice";

	public void addProductEc(JSONObject product, String xid_ec) {
